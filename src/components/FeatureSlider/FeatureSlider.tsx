...
const DEFAULT_ITEMS: FeatureSliderItem[] = [
  ...
  { title: 'Secure, compliant, accessible', body: 'Vero Assess meets the highest standards including ISO27001, ISO9001, Cyber Essentials Plus Certified and WCAG 2.2, keeping data safe and giving everyone the opportunity to perform.' },

...
interface Props {
  /** PDF URL shown to Starter buyers. Resolved server-side from siteSettings. */
  starterContractUrl: string;
  /** PDF URL shown to Growth / Scale / Bespoke buyers. Resolved server-side from siteSettings. */
  multiRoleContractUrl: string;
}
...
export default function ContractClient({ starterContractUrl, multiRoleContractUrl }: Props) {
  ...
  /* Switch on the buyer's tier. Default to the multi-role doc if the tier
     hasn't been resolved yet — it's the broader of the two. */

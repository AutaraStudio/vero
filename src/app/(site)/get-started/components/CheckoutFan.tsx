...
const SHAPES = [
  { colour: 'var(--swatch--purple-500)', opacity: 0.85, rotation: 40  },
  { colour: 'var(--swatch--blue-500)',   opacity: 0.85, rotation: 65  },
  { colour: 'var(--swatch--green-500)',  opacity: 0.85, rotation: 90  },
];

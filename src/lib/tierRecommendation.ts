...
export function getNudgeContent(
  ...
  if (tier === 'starter' && roleCount === 1) {
    return {
      ...
      toDetail: 'Up to 5 roles · from £825/mo',
    };
  }
...
export const TIER_DATA: Record<TierKey, TierInfo> = {
  ...
  essential: {
    ...
    stripePriceMonthly: 'price_1TOvSIS570ouCoaL68W8j2AQ',
  },
  growth: {
    key: 'growth',
    name: 'Growth',
    ...
    stripePriceMonthly: 'price_1TOvRwS570ouCoaLf9JdhNlM',
  },
  scale: {
    key: 'scale',
    name: 'Scale',
    ...
    stripePriceMonthly: 'price_1TOvRXS570ouCoaLXExL7wMs',
  },
  bespoke: {
    key: 'bespoke',
    name: 'Bespoke',
